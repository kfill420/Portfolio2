...
export function Leds({ instances }: LedsProps) {
  ...
  useFrame((state) => {
    ref.current.children.forEach((child) => {
      const instance = child as THREE.Mesh<
      ...
      if (instance.material && 'color' in instance.material && instance.material.color) {
        instance.material.color.setRGB(0, t * 1.1, t);
      }
    });
  });
  ...
  return (
    <group ref={ref}>
      <instances.Sphere position={[-0.41, 1.1, -2.21]} rotation={[0, 0, 0]} scale={0.005} color={[1, 2, 1]} />
      <instances.Sphere position={[0.59, 1.32, -2.22]} rotation={[0, 0, 0]} scale={0.005} color={[1, 2, 1]} />
      <instances.Sphere position={[1.77, 1.91, -1.17]} rotation={[0, 0, 0]} scale={0.005} color={[1, 2, 1]} />
      <instances.Sphere position={[2.44, 1.1, -0.79]} rotation={[0, 0, 0]} scale={0.005} color={[1, 2, 1]} />
      <instances.Sphere position={[4.87, 3.8, -0.1]} rotation={[0, 0, 0]} scale={0.005} color={[1, 2, 1]} />
      <instances.Sphere position={[1.93, 3.8, -3.69]} rotation={[0, 0, 0]} scale={0.005} color={[1, 2, 1]} />
      <instances.Sphere position={[-2.35, 3.8, -3.48]} rotation={[0, 0, 0]} scale={0.005} color={[1, 2, 1]} />
      <instances.Sphere position={[-4.71, 4.59, -1.81]} rotation={[0, 0, 0]} scale={0.005} color={[1, 2, 1]} />
      <instances.Sphere position={[-3.03, 2.85, 1.19]} rotation={[0, 0, 0]} scale={0.005} color={[1, 2, 1]} />
      <instances.Sphere position={[-1.21, 1.73, -1.49]} rotation={[0, 0, 0]} scale={0.005} color={[1, 2, 1]} />
    </group>
  );
}
...
export function SafePostEffects({ activeScene, onComposerReady }: { activeScene: number; onComposerReady?: () => void }) {
  ...
  if (device.device === 'mobile') return null;
